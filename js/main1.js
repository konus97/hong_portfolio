...
$(window).resize(function(){ 
        if (window.innerWidth >=480) {   
          ...
          function start() {
            time =setInterval(function(){
              $(".project").stop().animate({marginLeft:"-100%"},1500,function(){
                  $(".project li").first().appendTo(".project")
          ...
          $(".next").on("click", function () {
            clearInterval(time);
              $(".project").stop().animate({marginLeft:"-100%"},function(){
                $(".project li").first().appendTo(".project")
                $(".project").css({margin:"0px"})
              })
            start();
          ...
          $(".prev").on("click", function () {
            clearInterval(time);
            $(".project").stop().animate({marginLeft:"100%"},1000,function(){
              $(".project li").last().prependTo(".project");
              $(".project").css({margin:"0px"})
            });
          ...
          $(".web").on("mouseenter",function(){
            clearInterval(time);
            $(".pro_info").stop().animate({opacity:"1"})
          });
        ...
        if($(window).width() >= 1201) {
          $(" .link_page").on("mouseenter",function(){
            ...
            $(" .link_page").stop().css({borderColor:"#939664"})
            $(" .link_page").stop().css({color:"#fff"})
          });
          $(" .link_page").on("mouseleave",function(){
           
            $(" .link_page").stop().css({background:"none"})
            $(" .link_page").stop().css({borderColor:"#fcdd96"})
            $(" .link_page").stop().css({color:"#fcdd96"})
          });
